...
INSERT INTO role SET name = 'Authority', code = 'authority', description = 'Access given to an authority to view a pilot log.';
INSERT INTO role SET name = 'Other', code = 'other', description = 'Use for other purposes. Not meant for any specific usage.';
